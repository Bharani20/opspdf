...
## Package name      : perl5
## Source directory  : .
## Configuration time: Tue Jan 17 10:57:07 EST 2023
## Configured by     : Red Hat, Inc.
## Target system     : linux x86-64-02.build.eng.rdu2.redhat.com 4.18.0-305.25.1.el8_4.x86_64 #1 smp mon oct 18 14:34:11 edt 2021 x86_64 x86_64 x86_64 gnulinux 
#
...
cf_time='Tue Jan 17 10:57:07 EST 2023'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
incpath=''
incpth='/usr/lib/gcc/x86_64-redhat-linux/8/include /usr/local/include /usr/include'
inews=''
...
libsdirs=' /lib64'
libsfiles=' libpthread.so libresolv.so libgdbm.so libdb.so libdl.so libm.so libcrypt.so libutil.so libc.so libgdbm_compat.so'
libsfound=' /lib64/libpthread.so /lib64/libresolv.so /lib64/libgdbm.so /lib64/libdb.so /lib64/libdl.so /lib64/libm.so /lib64/libcrypt.so /lib64/libutil.so /lib64/libc.so /lib64/libgdbm_compat.so'
...
myuname='linux x86-64-02.build.eng.rdu2.redhat.com 4.18.0-305.25.1.el8_4.x86_64 #1 smp mon oct 18 14:34:11 edt 2021 x86_64 x86_64 x86_64 gnulinux '
n='-n'
need_va_copy='define'
...
phostname=''
pidtype='pid_t'
plibpth='/lib/x86_64-redhat-linux/8 /lib/../lib64 /usr/lib/x86_64-redhat-linux/8 /usr/lib/../lib64 /lib /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
...
ccflags_nolargefiles='-D_REENTRANT -D_GNU_SOURCE -O2 -g -pipe -Wall -Werror=format-security -Wp,-D_FORTIFY_SOURCE=2 -Wp,-D_GLIBCXX_ASSERTIONS -fexceptions -fstack-protector-strong -grecord-gcc-switches -specs=/usr/lib/rpm/redhat/redhat-hardened-cc1 -specs=/usr/lib/rpm/redhat/redhat-annobin-cc1 -m64 -mtune=generic -fasynchronous-unwind-tables -fstack-clash-protection -fcf-protection -fwrapv -fno-strict-aliasing -I/usr/local/include '
ldflags_nolargefiles='-Wl,-z,relro -Wl,-z,now -specs=/usr/lib/rpm/redhat/redhat-hardened-ld -fstack-protector-strong -L/usr/local/lib'
