...
unless(defined(&_SYS_CDEFS_H)) {
    ...
    eval 'sub __glibc_safe_or_unknown_len {
        my($__l, $__s, $__osz) = @_;
	    eval q((( &__builtin_constant_p ($__osz)  && ($__osz) == ( &__SIZE_TYPE__) -1) || ( &__glibc_unsigned_or_positive ($__l)  &&  &__builtin_constant_p ( &__glibc_safe_len_cond (( &__SIZE_TYPE__) ($__l), ($__s), ($__osz)))  &&  &__glibc_safe_len_cond (( &__SIZE_TYPE__) ($__l), ($__s), ($__osz)))));
