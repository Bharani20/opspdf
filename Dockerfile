...
# Set font config environment
ENV FONTCONFIG_PATH=/app/extracted/etc/fonts
ENV FONTCONFIG_FILE=/app/extracted/etc/fonts/fonts.conf

# Ensure the font cache directory exists
RUN mkdir -p /app/extracted/var/cache/fontconfig && \
    fc-cache -fv
